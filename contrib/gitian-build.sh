...
VERSION=
commit=false
url=https://github.com/PsiChain/bpq
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the psichain, gitian-builder, gitian.sigs, and bitcoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/PsiChain/psichain
