...
License:	MIT
URL:		https://psichain.org/
Source0:	https://psichain.org/download/psichain-core-%{version}/psichain-%{version}.tar.gz
...
%description
PsiChain is a digital cryptographic currency that uses peer-to-peer technology to
