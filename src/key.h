 ...
 */
typedef psicrypto::secure_vector<uint8_t> CPrivKey;
...
public:
	...
	CKey( psicrypto::secure_vector<uint8_t> const & raw_key, CKeyStore * keystore = nullptr)
		: m_pKeyStore(keystore)
		, fValid(false)
	{ 
	...
	void Set( psicrypto::secure_vector<uint8_t> const & raw_key, CKeyStore * keystore = nullptr)
    {
    ...
    void SetLegacy(psicrypto::secure_vector<uint8_t> const & raw, bool fCompressedIn = false)
	{
	...
	psicrypto::secure_vector<uint8_t> raw_private_key_legacy() const;

	//! returns key in new form: 1 byte prefix + payload of any size
	psicrypto::secure_vector<uint8_t> raw_private_key() const;
	
    size_t short_size() const;
	psicrypto::secure_vector<uint8_t> raw_short_key() const;
