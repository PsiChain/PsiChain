...
bool CBitcoinSecret::IsBitcoinSecret() const
{
	...
	bool fExpectedFormat = psicrypto::is_ecdsa_key(vchData.data(), vchData.size());
...
bool CBitcoinSecret::IsValid() const
{
	...
	bool fExpectedFormat = 
		psicrypto::is_xmss_key(vchData.data(), vchData.size()) ||
		psicrypto::is_xmss_short_key(vchData.data(), vchData.size()) ||
		psicrypto::is_ecdsa_key(vchData.data(), vchData.size());
	bool fCorrectVersion = vchVersion == Params().Base58Prefix(CChainParams::SECRET_KEY);
	return fExpectedFormat && fCorrectVersion;
}
