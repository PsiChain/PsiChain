...
public:
    CMainParams() {
        ...
        vSeeds.clear();
        vSeeds.emplace_back("dnsseed.mainnet.psichain.org");
        vSeeds.emplace_back("seed.mainnet.psichain.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.clear();        
        vSeeds.emplace_back("dnsseed.testnet.psichain.org");
        vSeeds.emplace_back("seed.testnet.psichain.org");
